...
public sealed class Employee : AuditableEntity
{
    ...
    public static Employee Create(string fullName, string? jobTitle, string? phoneNumber, string? email)
    {
        var employee = new Employee(Guid.NewGuid());
        employee.SetDetails(fullName, jobTitle, phoneNumber, email);
        return employee;
    }

    public void UpdateDetails(string fullName, string? jobTitle, string? phoneNumber, string? email) =>
        SetDetails(fullName, jobTitle, phoneNumber, email);

    private void SetDetails(string fullName, string? jobTitle, string? phoneNumber, string? email)
    {
