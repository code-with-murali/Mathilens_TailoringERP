...
public class GetMeasurementsByCustomerQueryHandlerTests
{
    ...
    public async Task Handle_ReturnsAllMeasurementsForCustomer()
    {
        ...
        var shirt = Measurement.Create(customerId, GarmentType.Shirt, new Dictionary<string, decimal> { ["Chest"] = 40 });
        var trousers = Measurement.Create(customerId, GarmentType.Trousers, new Dictionary<string, decimal> { ["Waist"] = 34 });
